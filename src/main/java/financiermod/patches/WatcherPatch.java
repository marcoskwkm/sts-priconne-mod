...
public class WatcherPatch {
    ...
    public static class DefectPatch$damagePatch2 {
        ...
        public static void Prefix(AbstractPlayer __instance, DamageInfo info) {
            if (__instance instanceof Watcher && info.owner != null && info.type != DamageType.THORNS && info.output - __instance.currentBlock > 0) {
    ...
    public static class DefectPatch$useCardPatch {
        ...
        public static void Prefix(AbstractPlayer __instance, AbstractCard c) {
            if (__instance instanceof Watcher && c.type == CardType.POWER) {
